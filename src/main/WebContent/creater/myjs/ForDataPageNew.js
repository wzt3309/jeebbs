 function flodEpsinit() {
   ...
   //alert(document.getElementById("dataNewFrame"));
    var frame_example=parent.document.getElementById("dataNewFrame").contentWindow;
    
    
    var form=frame_example.document.example;
    
    frame_example.document.getElementById("sql").value=retvalue;
    frame_example.document.getElementById("reccomendation").value=2;
    
    //form.action="?reccomendation=1&qq=2&sql=1=1"+retvalue;
    form.submit();
    }
