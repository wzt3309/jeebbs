...
public static List<String> seled(String ret){
		
		String toreturn=ret.replaceAll("and", "并且");
		toreturn=toreturn.replaceAll("or", "或者");
		toreturn=toreturn.replaceAll("OR", "或者");
		toreturn=toreturn.replaceAll("AND", "并且");
		System.out.println(toreturn);
		
		return SetToList(toreturn);
	}
	
   public static List<String> seledReal(String ret){
		
		return  SetToList(ret);
	}
   
   public static List<String> SetToList(String ret){
	   ...
	   while(i!=-1){
		   String temp=rret.substring(0, i);
		   toret.add(temp);
		   //System.out.println(temp);
		   rret=rret.substring(i+1);
  ...
  // public static void main(String[] args){
	//	String sql="mgwfp < 1 and 1=1;mgwfp < 1 and 1=1;mgwfp < 1 and 1=1;";
	//	seled(sql);
