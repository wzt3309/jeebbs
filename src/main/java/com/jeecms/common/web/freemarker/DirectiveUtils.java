...
public abstract class DirectiveUtils {
	...
	public static String replace(String toreplace){
		...
		toreplace=toreplace.replaceAll("mgwfp", "MGWFP");
		toreplace=toreplace.replaceAll("jtsyl", "JTSYL");
		toreplace=toreplace.replaceAll("sjl", "SJL");
		toreplace=toreplace.replaceAll("jzcsyl", "JZCSYL");
		toreplace=toreplace.replaceAll("mgzysy", "MGZYSY");
		toreplace=toreplace.replaceAll("mgjyxjl", "MGJYXJL");
		toreplace=toreplace.replaceAll("gdqyb", "GDQYB");
		toreplace=toreplace.replaceAll("ltgb", "LTGB");
		toreplace=toreplace.replaceAll("zgb", "ZGB");
		toreplace=toreplace.replaceAll("ltsz", "LTSZ");
		toreplace=toreplace.replaceAll("zsz", "ZSZ");
		toreplace=toreplace.replaceAll("mgsy", "MGSY");
