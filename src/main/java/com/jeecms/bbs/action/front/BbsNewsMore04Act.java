...
@Controller
public class BbsNewsMore04Act {
	
	@RequestMapping(value="/BbsNews/read/more04.jhtml")	
...
//		
		if(pagenum!=null){
			...
			else if(after.equalsIgnoreCase("1")&&before.equalsIgnoreCase("0")&&listS>bn){
				//翻下一页
				bn+=size;
		...
		return "/WEB-INF/t/cms/www/blue/新闻页面/more_web04.html";
